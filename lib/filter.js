...
Filter.prototype.toFilename = function(){ 
    if(Object.prototype.toString.call(this.str) === "[object Object]"){
        this.str = this.str.toString();
    }
    else if(this.str == "null" || this.str == "undefined" || this.str == "Nan"){
        this.str = "";
    }
    else {
        this.str = "" + this.str;
    ...
    var fnRegex = new RegExp(forbiddenCharacters, "gi");
    this.modify(this.str.replace(fnRegex, ""));
    return this.str;
}
