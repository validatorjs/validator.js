...
let validator_js = fs
  .readFileSync(require.resolve("../validator.js"))
  .toString();
...
describe("Validators", () => {
  ...
  it("should validate URLs without protocol", () => {
    ...
    test({
      ...
      valid: ["custom:something", "myscheme:data"],
      invalid: [],
    });
  });
  ...
  it("should validate URLs with custom protocols", () => {
    test({
      ...
      valid: ["rtmp://foobar.com", "rtmp:foobar.com"],
      invalid: ["http://foobar.com", "tel:+15551234567"],
    });
  });
  ...
  it("should validate authentication strings if a protocol is not required", () => {
    test({
      ...
      valid: ["user:pw@foobar.com/"],
      invalid: ["user:pw,@foobar.com/"],
    });
  });
  ...
  it("should reject invalid protocols when require_valid_protocol is enabled", () => {
    test({
      ...
      valid: ["http://example.com", "https://example.com", "ftp://example.com"],
      invalid: [
        // eslint-disable-next-line no-script-url
        "javascript:alert(1);@example.com",
        "data:text/html,<script>alert(1)</script>@example.com",
  ...
  it("should validate passport number", () => {
    ...
    test({
      validator: "isPassportNumber",
      args: ["MX"],
      valid: ["G98639222", "N23457890"],
      invalid: ["ABC34567890", "43986369222", "N234578909", "34567890"],
    });
