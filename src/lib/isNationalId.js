...
const nationalities = {
  ...
  BD: /^[0-9]{13,17}$/,
  AT: /^\d{9,12}$/,
  HK: /^[A-Z]{1,2}\d{10}(([\d|A]{1})|(\([\d|A]{1}\)))$/,
  IE: /^\d{7}[A-Z](\/[A|H|W]){0,1}$/,
  ...
  FR: /^(1|2)(\d{2})(0[1-9]|1[0-2])(([A-Z][0-9])|([0-9]{2,3}))(\d{2,3})(\d{5})$/, // INSEE code
  ...
  IT: /^[A-Z]{6}\d{2}[A|B|C|D|E|H|L|M|P|R|S|T]((0[1-9]|[1-2]\d|3[0-1])|(4[1-9]|[5-6]\d|7[0-1]))([A-Z]\d{3})([A-Z]|[0-9])$/,
  JP: /^\d{12}$/,
