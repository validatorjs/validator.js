...
const cards = {
  ...
  rupay: /^(?:508[5-9][0-9]{12}|6069(?:8[5-9]|9[0-9])[0-9]{10}|607(?:[0-8][0-9]{2}|9(?:[0-7][0-9]|8[0-4]))[0-9]{10}|608(?:00[1-9]|0[1-9][0-9]|[1-4][0-9]{2}|500)[0-9]{10}|6521[5-9][0-9]{11}|652[2-9][0-9]{12}|6530[0-9]{12}|6531[0-4][0-9]{11}|817[2-9][0-9]{12}|81[89][0-9]{13}|820[01][0-9]{12})$/,
